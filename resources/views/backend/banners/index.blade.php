                                ...
                                <tr id="banner-{{$banner->id}}">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.banner.destroy', $banner) }}"
                                            class="btn btn-danger btn-sm dltBtn" data-id="{{ $banner->id }}"
                                            style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip"
                                            title="Delete" data-placement="bottom"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                    {{-- Delete Modal --}}
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                ...
                                success: response => {
                                    const deletedBannerElement = $(`#banner-${response.deletedBannerId}`).remove()
                                    swal("Deleted", "Your data is safe!", "success");
                                },
                                error: error => {
